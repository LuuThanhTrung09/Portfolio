...
// FIX 3: Swiper chỉ khởi tạo khi tồn tại .slider-wrapper trên trang
// Nếu không guard, JS crash ở đây sẽ làm toàn bộ code phía dưới (menu, login) không chạy
...
document.addEventListener("click", function (e) {
  ...
  if (
    ...
    (target.textContent.includes("Account") ||
      target.href.includes("Account.html"))
  ) {
    const currentUser = sessionStorage.getItem("currentUser");
